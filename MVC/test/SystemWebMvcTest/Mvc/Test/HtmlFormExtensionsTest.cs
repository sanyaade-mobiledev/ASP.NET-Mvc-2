    ...
    public class HtmlFormExtensionsTest {
        ...
        public void BeginFormWithActionControllerInvalidFormMethodHtmlValues() {
            BeginFormHelper(
                ...
                @"<form action=""foo/bar"" baz=""baz"" method=""post"">");
        }
        ...
        public void BeginFormWithActionControllerFormMethodHtmlDictionary() {
            BeginFormHelper(
                ...
                @"<form action=""foo/bar"" baz=""baz"" method=""get"">");
        }
        ...
        public void BeginFormWithActionControllerRouteDictionaryFormMethodHtmlDictionary() {
            BeginFormHelper(
                ...
                @"<form action=""foo/bar/id"" baz=""baz"" method=""get"">");
        }
        ...
        public void BeginFormWithRouteValues() {
            BeginFormHelper(
                ...
                @"<form action=""home/someOtherAction/id"" method=""post"">");
        }
        ...
        public void BeginFormWithActionControllerRouteValues() {
            BeginFormHelper(
                ...
                @"<form action=""myController/myAction/id?pageNum=123"" method=""post"">");
        }
        ...
        public void BeginFormWithActionControllerRouteValuesMethod() {
            BeginFormHelper(
                ...
                @"<form action=""myController/myAction/id?pageNum=123"" method=""get"">");
        }
        ...
        public void BeginRouteFormWithRouteNameInvalidFormMethodHtmlValues() {
            BeginFormHelper(
                ...
                @"<form action=""named/home/oldaction"" baz=""baz"" method=""post"">");
        }
        ...
        public void BeginRouteFormWithRouteName() {
            BeginFormHelper(
                ...
                @"<form action=""named/home/oldaction"" method=""post"">");
        }
        ...
        public void BeginRouteFormWithRouteNameFormMethodHtmlDictionary() {
            BeginFormHelper(
                ...
                @"<form action=""named/home/oldaction"" baz=""baz"" method=""get"">");
        }
        ...
        public void BeginRouteFormWithRouteNameRouteDictionaryFormMethodHtmlDictionary() {
            BeginFormHelper(
                ...
                @"<form action=""named/home/oldaction/id"" baz=""baz"" method=""get"">");
        }
        ...
        public void BeginRouteFormWithRouteNameNullRouteValuesFormMethodNullHtmlValues() {
            BeginFormHelper(
                ...
                @"<form action=""named/home/oldaction"" method=""get"">");
        }
        ...
        public void BeginRouteFormWithRouteNameRouteValues() {
            BeginFormHelper(
                ...
                @"<form action=""named/home/oldaction/id?pageNum=123"" method=""post"">");
        }
        ...
        public void BeginRouteFormWithActionControllerRouteValuesMethod() {
            BeginFormHelper(
                ...
                @"<form action=""named/home/oldaction/id?pageNum=123"" method=""get"">");
        }
