...
namespace DynamicDataFuturesSample
{
	...
	public partial class TrainRoute : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _Start1;
		
		private System.Nullable<System.Guid> _Start2;
		
		private System.Nullable<System.Guid> _End2;
		
		private System.Nullable<int> _End1;
    ...
    partial void OnStart1Changing(System.Nullable<int> value);
    partial void OnStart1Changed();
    partial void OnStart2Changing(System.Nullable<System.Guid> value);
    partial void OnStart2Changed();
    partial void OnEnd2Changing(System.Nullable<System.Guid> value);
    partial void OnEnd2Changed();
    partial void OnEnd1Changing(System.Nullable<int> value);
    partial void OnEnd1Changed();
		...
		[Column(Storage="_RouteName", DbType="NChar(20)")]
		...
		[Column(Storage="_Start1", DbType="Int")]
		public System.Nullable<int> Start1
		{
			get
			{
				return this._Start1;
			...
			set
			{
				if ((this._Start1 != value))
				{
					...
					this.SendPropertyChanging();
					this._Start1 = value;
					this.SendPropertyChanged("Start1");
					this.OnStart1Changed();
				}
			}
		}
		
		[Column(Storage="_Start2", DbType="UniqueIdentifier")]
		public System.Nullable<System.Guid> Start2
		{
			get
			{
				return this._Start2;
			...
			set
			{
				if ((this._Start2 != value))
				{
					...
					this.SendPropertyChanging();
					this._Start2 = value;
					this.SendPropertyChanged("Start2");
					this.OnStart2Changed();
				}
			}
		}
		
		[Column(Storage="_End2", DbType="UniqueIdentifier")]
		public System.Nullable<System.Guid> End2
		{
			get
			{
				return this._End2;
		...
		[Column(Storage="_End1", DbType="Int")]
		public System.Nullable<int> End1
		{
			get
			{
				return this._End1;
		...
		[Association(Name="City_TrainRoute", Storage="_City", ThisKey="End1,End2", OtherKey="ID1,ID2", IsForeignKey=true)]
		public City City
		{
			get
			{
			...
			set
			{
							...
							|| (this._City.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((value != null))
					{
						...
						this._End1 = value.ID1;
						this._End2 = value.ID2;
					}
					else
					{
						this._End1 = default(Nullable<int>);
						this._End2 = default(Nullable<System.Guid>);
					}
					this.SendPropertyChanged("City");
				}
			}
		...
		[Association(Name="City_TrainRoute1", Storage="_City1", ThisKey="Start1,Start2", OtherKey="ID1,ID2", IsForeignKey=true)]
		public City City1
		{
			get
			{
			...
			set
			{
							...
							|| (this._City1.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.TrainRoutes1.Remove(this);
					}
					this._City1.Entity = value;
					if ((value != null))
					{
						value.TrainRoutes1.Add(this);
						this._Start1 = value.ID1;
						this._Start2 = value.ID2;
					}
					else
					{
						this._Start1 = default(Nullable<int>);
						this._Start2 = default(Nullable<System.Guid>);
					}
	...
	public partial class City : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<TrainRoute> _TrainRoutes1;
    ...
    partial void OnID2Changing(System.Guid value);
    ...
    partial void OnPopulationChanged();
		...
		public City()
		{
			...
			this._TrainRoutes1 = new EntitySet<TrainRoute>(new Action<TrainRoute>(this.attach_TrainRoutes1), new Action<TrainRoute>(this.detach_TrainRoutes1));
			OnCreated();
		}
		
		[Column(Storage="_ID1", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int ID1
		{
			get
			{
		...
		[Column(Storage="_ID2", DbType="UniqueIdentifier NOT NULL", IsPrimaryKey=true)]
		...
		[Association(Name="City_TrainRoute", Storage="_TrainRoutes", ThisKey="ID1,ID2", OtherKey="End1,End2")]
		...
		[Association(Name="City_TrainRoute1", Storage="_TrainRoutes1", ThisKey="ID1,ID2", OtherKey="Start1,Start2")]
		public EntitySet<TrainRoute> TrainRoutes1
		{
			get
			{
				return this._TrainRoutes1;
			}
			set
			{
				this._TrainRoutes1.Assign(value);
			}
		}
		...
		private void attach_TrainRoutes1(TrainRoute entity)
		{
			this.SendPropertyChanging();
			entity.City1 = this;
		}
		
		private void detach_TrainRoutes1(TrainRoute entity)
		{
			this.SendPropertyChanging();
			entity.City1 = null;
		}
