<%@ Page Language="C#" MasterPageFile="~/Site.master" CodeBehind="Default.aspx.cs" Inherits="DynamicDataExtensionsSample._Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

    <h2>Dynamic Data Extensions sample site</h2>
    
    <p>This site demonstrates the use of various features supported by the Dynamic Data Extensions assembly.&nbsp; 
    ...
    <p>By default, Dynamic Data does not prepopulate relationship (foreign key) fields 
        ...
        from the URL.</p>
    <p><a href="http://localhost:22302/Territories/List.aspx?RegionID=2">Click here</a> to see this being used in the standard scaffold 
        Insert page for the 
        Territories table. Note that the table is already filtered by the Western region. Click on 
        the &quot;Insert new item&quot; link (or <a href="http://localhost:22302/Territories/Insert.aspx?RegionID=2">here</a>). 
