...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <aspX:LinqDataSource ID="DetailsDataSource" runat="server" EnableUpdate="true" />
            
            <aspX:QueryExtender TargetControlID="DetailsDataSource" ID="GridQueryExtender" runat="server">
