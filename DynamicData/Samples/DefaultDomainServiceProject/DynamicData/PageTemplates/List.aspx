    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="DD">
                ...
                <asp:DomainValidator runat="server" ID="GridViewValidator" ControlToValidate="GridView1" Display="None" />
            ...
            <futures:QueryExtender TargetControlID="GridDataSource" ID="GridQueryExtender" runat="server">
