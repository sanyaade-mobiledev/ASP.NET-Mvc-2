    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="DD">
                ...
                <asp:DomainValidator runat="server" ID="FormViewValidator" ControlToValidate="FormView1" Display="None" />
            ...
            <futures:QueryExtender ID="GridQueryExtender" TargetControlID="GridDataSource" runat="server">
            ...
            <asp:Panel ID="DetailsPanel" runat="server">
                ...
                <futures:QueryExtender TargetControlID="DetailsDataSource" runat="server">
