<%@ Page Language="C#" MasterPageFile="~/Site.master" CodeBehind="MultiForeignKeyFilter.aspx.cs" Inherits="DynamicDataProject.SamplePages.MultiForeignKeyFilter" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <h2><%= table.DisplayName%> - MultiForeignKey filter</h2>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            Category: <asp:DynamicFilter runat="server" ID="CategoryFilter" DataField="Category" Filter="MultiForeignKey" OnFilterChanged="OnFilterSelectedIndexChanged" /><br />
