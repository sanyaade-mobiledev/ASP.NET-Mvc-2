<%@ Page Language="C#" MasterPageFile="~/Site.master" CodeBehind="BooleanFilter.aspx.cs" Inherits="DynamicDataProject.SamplePages.BooleanFilter" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <h2><%= table.DisplayName%> - Boolean filter</h2>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            Discontinued: <asp:DynamicFilter runat="server" ID="CategoryFilter" DataField="Discontinued" Filter="Boolean" OnFilterChanged="OnFilterSelectedIndexChanged" /><br />
