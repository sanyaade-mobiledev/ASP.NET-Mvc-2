<%@ Page Language="C#" MasterPageFile="~/Site.master" CodeBehind="BooleanRadioFilter.aspx.cs" Inherits="DynamicDataProject.SamplePages.BooleanRadioFilter" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <h2><%= table.DisplayName%> - BooleanRadio filter</h2>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            Discontinued: <asp:DynamicFilter runat="server" ID="CategoryFilter" DataField="Discontinued" Filter="BooleanRadio" OnFilterChanged="OnFilterSelectedIndexChanged" /><br />
